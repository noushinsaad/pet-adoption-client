                ...
                <div className="grid grid-cols-5 grid-rows-3 gap-2 w-full h-1/2  p-3 md:w-1/2">
                    <div className="col-span-3 row-span-1">
                        <img
                            src={img1}
                            alt="Image 1"
                            className="w-full h-full object-cover rounded-full rounded-br-none shadow-xl"
                        />
                    </div>
                    <div className="col-span-2 row-span-2">
                        <img
                            src={img2}
                            alt="Image 2"
                            className="w-full h-full object-cover rounded-full rounded-bl-none shadow-xl"
                        />
                    </div>
                    <div className="col-span-2 row-span-2">
                        <img
                    ...
                    <div className="col-span-3 row-span-1">
                        <img
                            src={img4}
                            alt="Image 4"
                            className="w-full h-full object-cover rounded-full rounded-tl-none shadow-xl"
                        />
                    </div>
                </div>
