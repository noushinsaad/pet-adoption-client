...
const WhyAdopt = () => {
    return (
        <div className="bg-gradient-to-br from-green-50 py-20 px-6 md:px-20">
            <div className="text-center mb-16">
                <h2 className="text-4xl font-extrabold text-green-800 mb-6">Why Adopt?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                {/* Benefit 1 */}
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105 text-center">
           
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Save a Life</h3>
                ...
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Reduce Overpopulation</h3>
                    <p className="text-lg text-gray-700">
                ...
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Get a Loyal Companion</h3>
                    <p className="text-lg text-gray-700">
