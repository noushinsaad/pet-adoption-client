...
const PetCareTips = () => {
    return (
        <div className="bg-green-100 py-20 px-6 md:px-20">
            <div className="text-center mb-16">
                <h2 className="text-4xl font-extrabold text-green-800 mb-6">Pet Care Tips</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                {/* Tip 1 */}
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105">
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Nutrition & Diet</h3>
                ...
                {/* Tip 2 */}
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105">
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Regular Exercise</h3>
                    <p className="text-lg text-gray-700 mb-4">
                ...
                {/* Tip 3 */}
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105">
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Grooming & Hygiene</h3>
                    <p className="text-lg text-gray-700 mb-4">
                ...
                {/* Tip 4 */}
                <div className="bg-white p-10 shadow-xl rounded-xl border border-green-200 hover:shadow-2xl transform transition-transform hover:scale-105">
                    <h3 className="text-2xl font-bold text-green-700 mb-4">Vet Visits</h3>
                    <p className="text-lg text-gray-700 mb-4">
